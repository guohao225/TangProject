...
# bert配置
config_path = '../checkpoints/MiniRBT-h256-pt/albert_config_tiny_g.json'
checkpoint_path = '../checkpoints/MiniRBT-h256-pt/albert_model.ckpt'
dict_path = '../checkpoints/MiniRBT-h256-pt/vocab.txt'
...
# 标注数据
train_data = load_data('../data/china_daily/example.train')
valid_data = load_data('../data/china_daily/example.dev')
test_data = load_data('../data/china_daily/example.test')
